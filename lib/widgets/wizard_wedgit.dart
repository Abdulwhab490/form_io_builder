...
class WizardWedgit extends StatefulWidget{
  final pages;
  final  operationType;
  final mapAnswers;
  final title;
  ValueChanged?  onSubmit;
   WizardWedgit({this.pages,this.operationType,this.mapAnswers,this.title,this.onSubmit});
  @override
  State<WizardWedgit> createState() => _WizardState();
}

class _WizardState extends State<WizardWedgit> {
